...
class action_plugin_googleanalytics extends DokuWiki_Action_Plugin {
	...
	function _addHeaders (&$event, $param) {
		...
		$event->data["script"][] = array (
		  "type" => "text/javascript",
		  "_data" => "(function(){var ga = document.createElement('script'); ga.type = 'text/javascript'; ga.asy nc = true; ga.src = ('https:' == document.location.protocol ? 'https://ssl' : 'http://www') + 'stats.g.doubleclick.net/dc.js'; var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s); })();"
		);
